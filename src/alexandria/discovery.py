...
def discover_files(
    ...
    """
    try:
        return _discover_with_fd(root, follow_symlinks)
    except FileNotFoundError:
        return _discover_fallback(root, follow_symlinks)


def _discover_with_fd(root: Path, follow_symlinks: bool) -> list[Path]:
...
def _discover_fallback(root: Path, follow_symlinks: bool) -> list[Path]:
